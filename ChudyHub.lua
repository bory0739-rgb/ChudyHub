...
local function askForPassword()
    ...
    button.BackgroundColor3 = Color3.fromRGB(184, 43, 64)
    ...
    button.MouseButton1Click:Connect(function()
        if textBox.Text == correctPassword then
            ...
            textLabel.Text = "Błędne hasło! Spróbuj ponownie:"
            textBox.Text = ""
        end
    end)

    repeat wait() until not passwordGui.Parent or success
end
